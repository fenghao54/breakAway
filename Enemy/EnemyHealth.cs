...
{
    //相机抖动
    public CameraFollow shake_Camera;
    public float shake;
    ...
    void Awake()
    {
        ...
        shake_Camera = FindObjectOfType<CameraFollow>();
    }
