...
public class Pickup : MonoBehaviour
{
    ...
    public enum PickupType { Bullet, Bounce, Pierce, Health, AddBullet }
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        switch (pickupType)
        {
            ...
            //如果掉落物品为加子弹类的话，调用PlayerShooting中的加子弹函数
            case PickupType.AddBullet:
                other.GetComponentInChildren<PlayerShooting>().AddBullet(100);
                break;
        }
